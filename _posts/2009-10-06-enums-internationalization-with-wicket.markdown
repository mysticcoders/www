...
---
<p><em>(Editor&acirc;&euro;&trade;s note: <a href="http:&#47;&#47;yeswicket.com" target="_blank">Olivier Croisier<&#47;a> contributed this column from YesWicket.)<&#47;em></p>
...
Throughout this article, we'll use the Seasons Enum as an example :</p>
<pre lang="java" colla="+">
...
public abstract class EnumMessageKeyProvider {<br />
	private static EnumMessageKeyProvider provider = new DefaultEnumResourceKeyProvider();</p>
<p>	public static EnumMessageKeyProvider getDefault() {<br />
		return EnumMessageKeyProvider.provider;<br />
	}</p>
<p>	public static void setDefault(EnumMessageKeyProvider provider) {<br />
		EnumMessageKeyProvider.provider = provider;<br />
	}</p>
<p>	public abstract <t extends Enum<t>> String computeMessageKey(T enumValue);</p>
<p>	public static <t extends Enum<t>> String getMessageKey(T enumValue) {<br />
...
<&#47;pre></p>
<h2>Displaying internationalized enums<&#47;h2></p>
...
<pre lang="java" colla="+">
public class EnumPropertyModel<t extends Enum<t>> extends PropertyModel<string> {</p>
<p>	private Component component;</p>
<p>	public EnumPropertyModel(Object modelObject, String expression, Component resourceProvider) {<br />
...
<&#47;pre></p>
<h2>Selecting an enum with a DropDownChoice<&#47;h2></p>
...
<pre lang="java" colla="+">
public class EnumDropDownChoice<t extends Enum<t>> extends DropDownChoice<t> {</p>
<p>	public EnumDropDownChoice(String id, IModel<t> model) {<br />
		super(id);<br />
		setModel(model);<br />
		setChoiceRenderer(new EnumChoiceRenderer<t>(this));<br />
	}</p>
<p>	public EnumDropDownChoice(String id, IModel<t> model, EnumChoiceRenderer<t> choiceRenderer) {<br />
		super(id);<br />
		setModel(model);<br />
...
<pre lang="java" colla="+">
public class EnumChoiceRenderer<t extends Enum<t>> implements IChoiceRenderer<t> {</p>
<p>	&#47;** The Component used a the root of the I18N search process *&#47;<br />
	private final Component resourceProvider;</p>
<p>	public EnumChoiceRenderer(final Component resourceProvider) {<br />
