...
<pre lang="java" colla="+">
        add(historyDataView = new DataView("history", new HistoryDataProvider(pasteService), 10) {<br />
            protected void populateItem(Item item) {<br />
                ...
                final String[] contentLines = pasteItem.getContent().split("n");<br />
                ...
                item.add(new BookmarkablePageLink("viewLink2", ViewPublicPage.class, params) {<br />
                    @Override<br />
...
<pre lang="java" colla="+">public class HistoryDataProvider extends DefaultDataProvider {
    ...
    public HistoryDataProvider(PasteService pasteService) {<br />
        this.pasteService = pasteService;<br />
    }

    public Iterator iterator(int first, int count) {<br />
    ...
    public IModel model(Object object) {<br />
...
<pre lang="java" colla="+">public class HistoryPage extends BasePage {
    ...
    public HistoryPage() {<br />
        ...
        add(new PagingNavigator("pageNav", historyDataView));<br />
...
public class TestPastePage extends AbstractIntegrationTest {
    ...
    public void setup() {<br />
        ...
        tester = new WicketTester(MysticPasteApplication.class);<br />
        WebApplication app = tester.getApplication();

        app.addComponentInstantiationListener(new SpringComponentInjector(app, appctx));<br />
    }
