...
excerpt: "Here at Mystic, we do a lot of remote work using <a href=\"http://en.wikipedia.org/wiki/Internet_Relay_Chat\"
  ...
  so we turn off things like email notifications, twitter popups, and other such annoyances.
...
Conky on irc.freenode.net #basementcoders - the socat over ssh underpinnings originated with him<br /><br />
