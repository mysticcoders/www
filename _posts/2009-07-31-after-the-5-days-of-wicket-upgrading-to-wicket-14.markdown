...
public class HistoryDataProvider implements IDataProvider<PasteItem> {<br />
    ...
    public Iterator<PasteItem> iterator(int first, int count) {<br />
        try {<br />
    ...
    public IModel<PasteItem> model(PasteItem pasteItem) {<br />
...
<pre lang="java" colla="+">
   ...
   CommentListModel commentListModel = new CommentListModel(pasteModel.getObject().getId());<br />
