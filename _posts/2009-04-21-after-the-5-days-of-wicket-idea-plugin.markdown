...
excerpt: From the beginning of building out <a href="http://www.mysticpaste.com"
...
<img src="http://www.mysticcoders.com/wp-content/uploads/2009/04/picture-2.png" width="480" height="395" alt="Picture 2.png" /><br />
...
For a lot more in-depth information on plugin development, the <a href="http://www.jetbrains.net/confluence/display/IDEADEV/Plugin+Development+FAQ" title="Plugin Development FAQ" target="_blank">Plugin Development FAQ</a> is very useful.<br />
...
<pre lang="java" colla="+">
    private String sendPaste(String text, String extension) {
        ...
        return (pasteNumber != null ? "http://www.mysticpaste.com/view/" + pasteNumber : null);<br />
    }<br />
</pre>
...
You can test your app by running it like you would anything else, IDEA provides a target in the Run/Debug configurations to achieve this.<br />
